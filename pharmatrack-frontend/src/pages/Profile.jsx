...
import {
    getProfile, updateProfile, uploadAvatar, changePassword, IMAGE_BASE_URL
} from "../services/api";
import {
...
const Profile = () => {
    ...
    const fetchProfileData = async () => {
        try {
            ...
            // Synchronize with local storage immediately upon fetch
    ...
    const handleProfileUpdate = async (e) => {
        ...
        try {
            ...
            setIsEditMode(false);
            notify("Profile identity updated successfully!", "success");
        } catch (err) {
