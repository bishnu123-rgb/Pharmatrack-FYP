                                            ...
                                            <tr key={req.id} className={`group hover:bg-slate-50/50 transition-colors ${isReady ? 'bg-emerald-50/30' : ''}`}>
                                                <td className="px-8 py-6">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <span className="font-black text-slate-900 tracking-tight">{highlightText(req.customer_name, searchTerm)}</span>
                                                    </div>
                                                </td>
                                                <td className="px-8 py-6">
                                                    <a href={`tel:${req.customer_phone}`} className="flex items-center gap-2 text-indigo-600 font-bold hover:underline">
                                                        <Phone size={14} /> {highlightText(req.customer_phone, searchTerm)}
                                                    </a>
                                                </td>
                                                <td className="px-8 py-6">
                                                    <div>
                                                        <p className="font-black text-slate-800 text-sm tracking-tight">{highlightText(req.medicine_name, searchTerm)}</p>
